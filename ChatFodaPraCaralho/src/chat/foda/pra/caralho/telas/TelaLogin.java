...
public class TelaLogin extends JFrame{
	...
	public TelaLogin() {
		...
		String ip = JOptionPane.showInputDialog(null, "Selecione o IP: ", "Configurar conex�o", 
	...
	private JPanel getMainPanel() {
		...
		jlbRegistrar = new JLabel("Ainda n�o possui uma conta?");
				...
				if (!nome.isEmpty() && !senha.isEmpty()) {
					try {
						...
						if (usuarioLogado != null) {
							...
							JOptionPane.showMessageDialog(null, "Usu�rio n�o cadastrado ou senha incorreta!");
						}
					} catch (RemoteException e) {
						e.printStackTrace();
						JOptionPane.showMessageDialog(null, "Conex�o - Erro ao realizar login.");
					}
				} else {
					JOptionPane.showMessageDialog(null, "Login ou senha inv�lidos ou vazios!");
				}
			}
		});
